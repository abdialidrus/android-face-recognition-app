...
import com.abdialidrus.facerecognition.MainActivity;
...
public class TFLiteFaceRecognition
    ...
    public void register(String name, Recognition rec) {
        MainActivity.Companion.getRegistered().put(name, rec);
    }
    ...
    private Pair<String, Float> findNearest(float[] emb) {
        ...
        for (Map.Entry<String, Recognition> entry : MainActivity.Companion.getRegistered().entrySet()) {
    ...
    public Recognition recognizeImage(final Bitmap bitmap, boolean storeExtra) {
        ...
        if (MainActivity.Companion.getRegistered().size() > 0) {
